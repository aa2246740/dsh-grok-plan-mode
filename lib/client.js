...
`;
		//#endregion
		//#region \0dshx-css-module:/tmp/dsh-grok-plan-mode/src/client/PlanChip.module.css.mjs
		const css$1 = ".d9nR4G_wrap{align-items:center;gap:6px;display:inline-flex}.d9nR4G_chip,.d9nR4G_approval{cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;min-width:34px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.d9nR4G_chip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.d9nR4G_approval{background:var(--dsw-alias-state-info-tertiary,var(--dsw-alias-state-warn-tertiary));color:var(--dsw-alias-state-info-label,var(--dsw-alias-state-warn-label))}.d9nR4G_chip:hover:not(:disabled),.d9nR4G_approval:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}.d9nR4G_chip:disabled,.d9nR4G_approval:disabled{opacity:.6;cursor:default}.d9nR4G_close{align-items:center;display:inline-flex}.d9nR4G_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
		...
		function PlanChip({ useProjection, locked, leavePlanMode, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [approval ? "Plan approval" : "Plan", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.input.plan", () => ctx.slots.register({
				...
				locale: NS,
				inject: (sessionId) => ({ leavePlanMode: async () => {
					const result = await ctx.remote.commands.execute(sessionId, "/grok-plan-leave", []);
					if (!result.ok) return `${result.error.message} (${result.error.code})`;
					if (result.value === void 0) return "unknown command: /grok-plan-leave";
					return null;
				} })
			}, PlanChip));
